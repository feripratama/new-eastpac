            ...
            <div class="col-md-9">
                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <li class="list-group-item">
                            <b>Main Wallet Address </b> <a class="pull-right" id="main-wallet-config" onclick="showMainWalletConfig()">{{ $main_wallet_address }}</a>
                            <div class="input-group input-group-sm" id="main-wallet-config-input" style="display:none">
                                <input type="text" class="form-control" key="main-wallet-address" placeholder="Total D-Share Target" value="{{ $main_wallet_address }}">
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-success btn-flat" id="btnok-main-wallet-config"><i class="fa fa-check"></i></button>
                                    <button type="button" class="btn btn-danger btn-flat" id="btncancel-main-wallet-config"><i class="fa fa-times"></i></button>
                                </span>
                            </div>
                        </li>
                        </ul>
...
@section('script')
    <script>
        // $(document).ready(function(){
            ...
            $('#btnok-main-wallet-config').click(function() {
                $.ajax({
                    url: '/administrator/site-config/save-edit-config',
                    type: 'post',
                    data: {
                        _token: '{{csrf_token()}}',
                        val: $('#main-wallet-config-input input').val(),
                        key: $('#main-wallet-config-input input').attr('key')
                    },
                    error: function(datas, status, c) {
                        $('#msg').addClass('alert-danger');
                        $('#msg').removeClass('alert-success');
                    ...
                    success: function(datas, status,c) {
                        ...
                        $('#msg strong').text(datas.msg);
                        $('#msg').show();
                        $('#main-wallet-config').text($('#main-wallet-config-input input').val());
                        $('#main-wallet-config-input').hide();
                        $('#main-wallet-config').show();
        ...
        $('#btncancel-main-wallet-config').click(function(){
            $('#main-wallet-config-input').hide();
            $('#main-wallet-config').show();
        });
        ...
        function showMainWalletConfig() {
            $('#main-wallet-config').hide();
            $('#main-wallet-config-input').show();
            $('#main-wallet-config-input input').focus();
        }
