                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="input-group input-group-lg">
                                        <input type="text" class="form-control" id="est" style="border:1px solid #f39c12">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-lg">
                                        <input type="text" class="form-control" id="dshare" style="border:1px solid #f39c12">
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-warning btn-flat">D-SHARE</button>
                                        </span>
                                    </div>
                                </div>
                                <div class="col-md-2 div-btn-process"><button class="btn btn-lg btn-warning pull-right" id="process-exchange">Process</button></div>
                            </div><hr>
...
$('#est').keyup(function(){
    ...
    $('#dshare').val(resultEst);
});

$('#dshare').keyup(function(){
    var resultDshare = ($('#eth').val() * 1) * 10;
    $('#est').val(resultDshare);
})

$('#process-exchange').click(function() {
    // console.log($('#dshare').val())
    // $.ajax({
    //     url: "",
    //     method: "",
    //     success: function(a){
    ...
    swal({
        title: 'Success',
        icon: 'success',
        text: `Success you get (${$('#dshare').val()} D-SHARE)`,
        type: 'success'
    });
});
