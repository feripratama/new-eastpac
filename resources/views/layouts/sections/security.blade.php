                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label class="switch">
                                                ...
                                                <input type="checkbox" id="activityLog" checked><span class="slider round"></span>
                                                @else
                                                <input type="checkbox" id="activityLog"><span class="slider round"></span>
                                                @endif
                                            </label>
                                        </div>
...
<script>
        $('#activityLog').click(function(){
          $.ajax({
            type:'POST',
            url:'{{ route('home.security.activityLog') }}',
            data:{activityLog:$('#activityLog').val(),_token:'{{ csrf_token() }}'},
