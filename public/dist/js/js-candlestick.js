  ...
  "listeners": [{
    ...
    "method": function(e) {
      ...
      if (e.chart.firstPoint !== undefined) {
        // create a trend line
        var trend = new AmCharts.TrendLine();
        trend.initialDate = new Date(e.chart.firstPoint.category);
        trend.initialDate.setHours(12);
        trend.initialValue = e.chart.firstPoint.values.value;
        trend.finalDate = new Date(e.item.category);
        trend.finalDate.setHours(12);
        trend.finalValue = e.item.values.value;
        e.chart.addTrendLine(trend);
